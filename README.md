...
> **EEE 212 — Numerical Technique Laboratory | Project 06** > Bangladesh University of Engineering and Technology (BUET)  
> Department of Electrical and Electronic Engineering  
> **[Live Project Link](https://anikbiswas730.github.io/audio-modulation-demodulation/)**
...
1. Double-click `app/Project-06.mlappinstall` in MATLAB's Current Folder browser, or
2. In MATLAB: **Apps → Install App** → browse to `Project-06.mlappinstall`
...
### Step 2 — Modulate
1. Select **AM mod** or **FM mod** from the dropdown
2. For AM: set the **Amplitude of the carrier frequency** (A_c)
3. Press **Modulate** → Press **Play** to hear the modulated signal

### Step 3 — Add Noise
1. Turn the **Knob** to the desired SNR level (0 = maximum noise, 100 = nearly noiseless)
2. The SNR value is shown in the **Noise** field
3. Press **Add Noise** → Press **Play**
...
See the full report in [`docs/EEE212_Project06_Report.pdf`](docs/EEE212_Project06_Report.pdf) for all screenshots.
